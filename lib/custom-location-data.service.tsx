...
export async function addCustomLocationDataset(payload: IData[], token: string) {
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}custom-locations/data/add-dataset`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${token}`
